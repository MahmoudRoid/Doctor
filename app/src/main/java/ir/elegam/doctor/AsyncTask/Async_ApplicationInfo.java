...
public class Async_ApplicationInfo extends AsyncTask <Object, Object, Object> {

    String res = "";
    public GetAppInfo mListener;

    public interface GetAppInfo {
        void onGetAppInfo(String res);
    }
