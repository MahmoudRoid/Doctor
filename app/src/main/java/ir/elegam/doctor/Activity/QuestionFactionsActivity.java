...
public class QuestionFactionsActivity extends AppCompatActivity implements Async_Category.GetServices {
    ...
    private void define() {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_questionfaction);
        setSupportActionBar(toolbar);
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        fab = (FloatingActionButton) findViewById(R.id.questionfaction_fab);
        txtToolbar = (TextView) findViewById(R.id.txtToolbar_appbar);
        coordinatorLayout = (CoordinatorLayout) findViewById(R.id.coordinate_questionfaction);
        txtToolbar.setTypeface(San);

        rv = (RecyclerView) findViewById(R.id.questionfaction_recycler);
        LinearLayoutManager lm = new LinearLayoutManager(QuestionFactionsActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void setSweetDialog(){
        pDialog= new SweetAlertDialog(QuestionFactionsActivity.this, SweetAlertDialog.PROGRESS_TYPE);
    ...
    private void Snackbar_show(String message){
        ...
        sbView.setBackgroundColor(ContextCompat.getColor(QuestionFactionsActivity.this, R.color.white));
        snackbar.show();
    }// end Snackbar_show()
